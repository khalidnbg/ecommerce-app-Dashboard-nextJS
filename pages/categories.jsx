        ...
        <div className="mx-auto px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
              ...
              <div>
                <div className="relative">
                  ...
                  <input
                    type="text"
                    id="example11"
                    className="block w-[400px] rounded-md border border-slate-300 py-2.5 pl-8 pr-16 shadow-sm disabled:cursor-not-allowed disabled:bg-gray-50 disabled:text-gray-500"
          ...
          <div className="overflow-x-auto mx-auto p-4">
            {loading ? (
              ...
              <p className="w-full text-center">No Category available.</p>
            ) : (
                  ...
                  >
                    <tr>
                      ...
                      <td className="whitespace-nowrap px-4 py-2 gap-4 flex">
                        ...
                        <div className="inline-block rounded bg-red-600 text-xs font-medium text-white hover:bg-red-700">
